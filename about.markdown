...
<!-- TODO: Replace the paragraph below with specifics — what you're working on
     right now, coursework or certifications (the SC-500 tag on your first post
     suggests one), clubs, CTF teams, internships, or jobs. This is the part
